        ...
        <div className={styles['sort-block']}>
            <ul className={styles['sort-block-list']}>
                <li className={styles['sort-block-item']}>
                    ...
                    <span className={styles['sort-text']}>Просмотренное</span>
                </li>
                <li className={styles['sort-block-item']}>
                    ...
                    <span className={styles['sort-text']}>Сохранённое</span>
                </li>
                <li className={styles['sort-block-item']}>
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"
                         className={styles['svg']}>
                    ...
                    <span className={styles['sort-text']}>Мои посты</span>
                </li>
                <li className={styles['sort-block-item']}>
                    ...
                    <span className={styles['sort-text']}>Прокомментированное</span>
                </li>
            </ul>
